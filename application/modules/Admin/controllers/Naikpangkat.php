...
class Naikpangkat extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Naikpangkat_m', 'primaryModel');
    }
    public $titles = 'Naik Pangkat';
    public $vn = 'Naikpangkat';
    ...
    function ajaxpegawai()
    {
        ...
        if (empty($row->namaPegawai)) :
            $data = [
                ...
                'pangkatgolongan' => 'Data Pegawai Tidak ditemukan',
                'devisi' => 'Data Pegawai Tidak ditemukan',
            ];
