        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Pindah ke Devisi</label>
                        <?= cmb_dinamis('devisiTujuan', 'devisi', 'namaDevisi', 'idDevisi', $row->devisiTujuan) ?>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Tanggal Mutasi</label>
                        <input type="date" name="tanggalMutasi" value="<?= $row->tanggalMutasi ?>" id="validationCustom01" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
