        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Jumlah Hari Aktif Bekerja</label>
                        <input type="text" name="jumlahHariKerja" value="<?= $row->jumlahHariKerja ?>" id="validationCustom01" class="form-control angka" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
