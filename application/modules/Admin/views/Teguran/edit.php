            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="kesalahan" value="<?= $row->kesalahan ?>" id="devisi" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="hukuman" value="<?= $row->hukuman ?>" id="devisi" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="tanggalTeguran" value="<?= $row->tanggalTeguran ?>" id="validationCustom01" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
