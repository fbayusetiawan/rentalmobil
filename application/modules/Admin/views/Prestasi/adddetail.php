        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($ctrl . '/adddetailAction/' . $this->uri->segment(4)) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Nama Pegawai</label>
                        <select data-plugin="customselect" name="nik" required class="form-control" data-placeholder="Silahkan Pilih Anggota Anda ">
                            <option></option>
                            <?php foreach ($pegawai as $p1) : ?>
                                <option value="<?= $p1->nik ?>"><?= $p1->nik ?> - <?= $p1->namaPegawai ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">
                            Harus di isi.
