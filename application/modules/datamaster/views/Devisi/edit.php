            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    <div class="form-group mb-3">
                        ...
                        <?= cmb_dinamis('idDepartemen', 'departemen', 'namaDepartemen', 'idDepartemen', $row->idDepartemen) ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= $row->namaDevisi ?>" name="namaDevisi" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
