            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/addAction') ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="gapok" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="tjTransport" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="tjMakan" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
