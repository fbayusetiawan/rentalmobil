...
<body>
    ...
    <h3>
        <center>
            DATA SUPIR CV NASIR RENTAL BANJARMASIN
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">TTL</th>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td style="text-align:center; width: 100;"><?= $row->tempatLahir . ',  ' . tgl_indo($row->tanggalLahir) ?></td>
                                <td style="text-align:center; width: 20;"><?= fd_jk($row->jk) ?></td>
                                <td style="text-align:center; width: 100;"><?= $row->noWa ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
