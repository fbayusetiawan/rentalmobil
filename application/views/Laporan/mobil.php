                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">Warna</th>
                            <th style="text-align:center; font-size: 18px;">Kursi</th>
                            <th style="text-align:center; font-size: 18px;">Harga Sewa (perhari)</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td style="text-align:center; width: 100;"><?= $row->warnaMobil ?></td>
                                <td style="text-align:center; width: 40;"><?= $row->jumlahKursi ?></td>
                                <td style="text-align:center; width: 80;">Rp.<?= number_format(floatval($row->hargaSewa), 0, ',', '.') ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
